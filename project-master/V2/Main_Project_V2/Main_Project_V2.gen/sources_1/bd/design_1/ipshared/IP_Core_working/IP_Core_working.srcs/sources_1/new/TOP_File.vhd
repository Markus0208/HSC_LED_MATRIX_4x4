...
signal prescale_value2 : unsigned(15 downto 0) := x"002A"; --100MHz/42 = 2.380kHz -> 3 TRANSMIT BITS
--signal prescale_value2 : unsigned(15 downto 0) := x"0019"; --100MHz/25 = 4.000kHz -> 5 TRANSMIT BITS
...
signal s0_axis_tdata_sig : std_logic_vector(23 downto 0);
...
begin
-- AXI tdata is 32 Bit width. Input is 24 Bit for other LEDs 32 Bit is needed. Then change shift register as well
    s0_axis_tdata_sig <= s0_axis_tdata(23 downto 0);
    ...
    shift : entity work.shift_register_x24 port map(
        ...
        input_data 	    => s0_axis_tdata_sig,  -- from DMA
